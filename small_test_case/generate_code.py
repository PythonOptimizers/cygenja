...
def create_logger(config):
    logger_name = config.get('CODE_GENERATION', 'log_name')
    if logger_name == '':
        logger_name = '_generator'

    logger = logging.getLogger(logger_name)

    # levels
    log_level = LOG_LEVELS[config.get('CODE_GENERATION', 'log_level')]
    console_log_level = LOG_LEVELS[config.get('CODE_GENERATION',
                                              'console_log_level')]
    file_log_level = LOG_LEVELS[config.get('CODE_GENERATION',
                                           'file_log_level')]
